...
func TestConsoleIncludesExportActions(t *testing.T) {
	...
	for _, want := range []string{
		...
		"id=\"m-quota-rejected\"",
		"id=\"m-app-quota-rejected\"",
		"id=\"m-provider-quota-rejected\"",
		"id=\"m-quota-checked\"",
		"id=\"trace-app-filter\"",
		...
		"function renderMCPServerLinks",
		"function renderTraceLink",
		"function filterProviderByID",
		"function filterProviderByClass",
		...
		"function filterPolicyByField",
		"data-provider-link-id",
		"data-provider-class-link",
		"data-model-link-id",
		...
		"function renderAuditChangeSummary",
		"function renderAuditChangeValue",
		"function renderAuditMetadataSummary",
		"function renderAuditMetadataValue",
		...
		"function copyText",
		"trace-fill-quick",
		"data-trace-policy-id",
		"button[data-trace-policy-id]",
		"trace-view-audit",
		"viewTraceAudit",
		"trace-copy-request",
		"trace-copy-curl",
		"traceSnapshotSafetyTitle",
		"traceSnapshotSafetyBody",
		"traceCopySafetyHint",
		"traceRequestCopied",
		"traceCurlCopied",
		"metadata_key",
		"metadata_value",
		"data-audit-metadata-key",
		...
		"function fillPolicyDryRunFromPolicy",
		"function fillAndRunPolicyDryRunFromPolicy",
		...
		"function invokeTool()",
		"function renderToolTraceAction",
		"openToolTrace",
