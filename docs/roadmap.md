...
| 配额预算与限流 | 已完成 App RPM MVP | 已有 App 级 requests_per_minute 限流；Provider 预算、token/day 和成本统计仍是设计草案。 |
...
| P2 | 配额 / 预算 / 速率限制 | 已完成 App RPM MVP，后续补 Provider 预算、token/day 记账和控制台配额面板。 |
